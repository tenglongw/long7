...
class goods_classControl extends SystemControl{
	...
	public function goods_classOp(){
		...
		if ($_GET['ajax'] == '1'){
			...
			//echo json_encode($tmp_list);exit;
...
// 		echo json_encode($_GET['gc_parent_id']);exit;
	...
	public function goods_class_editOp(){
		...
		//echo json_encode($class_array);exit;
