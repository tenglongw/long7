...
<div class="page">
  ...
  <form id="goods_class_form" name="goodsClassForm" enctype="multipart/form-data" method="post">
    ...
    <input type="hidden" name="gc_parent_id" id="gc_parent_id" value="<?php echo $output['gc_parent_id']?>" />
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" maxlength="20" value="" name="gc_name" id="gc_name" class="txt"></td>
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation">上级分类:</label>
           <!--  <span>
        ...
        <!-- <tr class="noborder">
          <td colspan="2" id="goodsClass">
            <select class="class-select">
              <?php foreach ($output['gc_list'] as $value){?>
        ...
        <!-- <tr class="noborder">
          <td colspan="2" id="gcategory">
            ...
            <?php foreach ($output['type_list'] as $value){?>
              	<option value="<?php echo $value['type']['type_id']?>"><?php echo $value['name']?></option>
              <?php }?>
             </select>（快捷定位）</td>
        </tr> -->
        <tr class="noborder">
...
// 		$("#gc_parent_id").val($("#goodsClass").last().val());
// 		alert($("#goodsClass").last().val());
		$("#gcategory").last().attr("id",'t_id');
