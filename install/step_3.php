    ...
    <div class="form-box control-group">
      <fieldset>
        ...
        <div>
          <label>数据库名</label>
          <span>
          <input type="text" name="db_name" maxlength="50" value="<?php echo $_POST['db_name'] ? $_POST['db_name'] : 'wrzcnet';?>">
          </span> <em></em></div>
        <div>
          <label>数据库用户名</label>
          <span>
        ...
        <div  style="DISPLAY: none" >
          <label>数据库表前缀此处不用填</label>
          <span>
          <input     readOnly=”true”   type="text" name="db_prefix" maxlength="30" value="<?php echo $_POST['db_prefix'] ? $_POST['db_prefix'] : 'wrzcnet_';?>">
      ...
      <fieldset>
        <legend>网站信息</legend>
        <div>
          <label>站点名称默认不用填写</label>
          <span>
          <input name="site_name" value="创智凌云B2B2C多用户商城系统" maxlength="100"   readOnly=”true”  type="text">
      </span> <em>输入站点名称，安装后可在平台设置中进行修改</em></div>
        <div>
          <label>管理员帐号默认不用填写</label>
          <span>
          <input name="admin" value="admin" maxlength="20"  readOnly=”true”   type="text">
      </span> <em></em></div>
        <div>
          <label>管理员密码默认不用填写</label>
          <span>
          <input name="password" id="password" maxlength="20" value="admin888"  readOnly=”true” >
      </span> <em>管理员密码不少于6个字符</em></div>
        <div>
          <label>重复密码默认不用填写</label>
          <span>
          <input name="rpassword" value="admin888" maxlength="20"  readOnly=”true” >
      </span> <em>确保两次输入的密码一致</em></div>
      </fieldset>
      <fieldset>
        <legend>官方店铺信息</legend>
        <div>
          <label>店铺名称默认不用填写</label>
          <span>
            <input name="store_name" value="演示店铺" maxlength="50"  readOnly=”true”  type="text">
          </span>
          <em>官方店铺的店铺名称</em>
        </div>
        <div>
          <label>会员用户名默认不用填写</label>
          <span>
            <input name="member_name" value="admin" maxlength="50"   readOnly=”true”  type="text">
          </span>
          <em>在买家入口登录的用户名</em>
      </div>
        <div>
          <label>商家用户名默认不用填写</label>
          <span>
            <input name="seller_name" value="admin" maxlength="50"   readOnly=”true”  type="text">
          </span>
          <em>在商家入口登录的用户名</em>
      </div>
        <div>
          <label>登录密码默认不用填写</label>
          <span>
            <input name="member_password" id="member_password" value="123456" maxlength="20"  readOnly=”true” >
          </span>
        ...
        <div>
          <label>重复密码默认不用填写</label>
          <span>
            <input name="rmember_password" value="123456" maxlength="20"  readOnly=”true” >
          </span>
          <em></em>
      </div>
      </fieldset>
