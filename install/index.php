...
<div class="header">
  <div class="layout">
    ...
    <div class="version">版本: V2030目前最新版</div>
  </div>
</div>
...
$html_footer = <<<EOF
<div class="footer">
  <h6><a href="http://www.wrzc.net" target="_blank"></a></h6>
</div>
EOF;
...
function step3(&$install_error,&$install_recover){
    ...
    if ($_POST['demo_data'] == '1'){
        $db->query("UPDATE {$db_prefix}store SET `live_store_name`='小刘',`live_store_address`='广州市天河区国家软件园产业基地8栋203',`live_store_tel`='020-34506590',`live_store_bus`='地铁3号线,地铁3号线，5号线' WHERE `store_id`=1");
