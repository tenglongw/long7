...
<div class="main">
  ...
  <p><strong>安装完成，请首先进入后台，右上角找到"更新站点缓存“-->"全部"-->"提交":&nbsp;</strong><a href="<?php echo substr($auto_site_url,0,-8);?>/admin/index.php?act=cache&op=clear" target="_blank"><?php echo substr($auto_site_url,0,-8);?>/admin/index.php?act=cache&op=clear</a></p>
