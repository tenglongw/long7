...
//	}
	...
	$compile .= "\nBase::run();";
	file_put_contents(RUNCOREPATH,compress_code("<?php defined('InWrzcNet') or exit('Access Invalid!');".$compile));
}
...
function compile($filename) {
    ...
    $content = str_ireplace("defined('InWrzcNet') or exit('Access Invalid!')", '', $content);
