 ...
 */
function showEditor($id, $value='', $width='700px', $height='300px', $style='visibility:hidden;',$upload_state="true", $media_open=true, $type='all'){
	//是否开启多媒体
	$media = '';
	if ($media_open){
		$media = ", 'flash', 'media'";
	...
	echo '
<script src="'. RESOURCE_SITE_URL .'/kindeditor/kindeditor-all.js" charset="utf-8"></script>
...
function write_file($filepath, $data, $mode = null)
{
    ...
    $data = "<?php defined('InWrzcNet') or exit('Access Invalid!'); return ".$data.";";
