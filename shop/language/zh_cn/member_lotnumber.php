 ...
 * 摇号字段
 **/
$lang['group_template'] = '摇号活动';
$lang['group_template_tip'] = '选择要参加的摇号活动及时间段';
$lang['group_name'] = '商品名称';
$lang['group_name_tip'] = '摇号标题名称长度最多可输入30个字符';
$lang['group_goods_sel'] = '选择商品';
$lang['group_help'] = '摇号说明';
$lang['start_time'] = '开始时间';
$lang['end_time'] = '结束时间';
$lang['goods_price'] = '商品原价';
$lang['goods_storage'] = '商品库存数';
$lang['store_price'] = '商城价';
$lang['groupbuy_price'] = '摇号价格';
$lang['groupbuy_price_tip'] = '摇号价格为该商品参加活动时的促销价格<br/>必须是0.01~1000000之间的数字(单位：元)<br/>摇号价格应包含邮费，摇号商品系统默认不收取邮费';
...
$lang['win_quantity'] = '中奖数量';
$lang['win_rate'] = '中奖率';

$lang['groupbuy_class'] = '摇号类别';
$lang['lotnumber_rule'] = '摇号规则';
$lang['groupbuy_class_tip'] = '请选择摇号商品的所属类别';
$lang['lotnumber_rule_tip'] = '请选择摇号的中奖规则';
$lang['groupbuy_area'] = '所属区域';
$lang['groupbuy_goods'] = '摇号商品';
$lang['groupbuy_goods_explain'] = '点击上方输入框从已发布商品中选择要参加摇号的商品';
$lang['min_quantity_explain'] = '摇号成功的最低数值，默认为 "1"';
$lang['virtual_quantity_explain'] = '虚拟购买数量，只用于前台显示，不影响成交记录';
$lang['apply_quantity_explain'] = '允许报名的最大人数';
$lang['sale_quantity_explain'] = '每个买家ID可摇号的最大数量，不限数量请填 "0"';
$lang['max_num_explain'] = '摇号商品总数应等于或小于该商品库存数量<br/>请提前确认要参与活动的商品库存数量足够充足';
$lang['group_pic_explain'] = '用于摇号活动页面的图片,请使用宽度340像素、高度260像素、大小1M内的图片，<br/>支持jpg、jpeg、gif、png格式上传。';
$lang['group_pic_explain2'] = '用于摇号页侧边推荐位，首页推荐位的图片,请使用宽度210像素、高度180像素、大小1M内的图片，<br/>支持jpg、jpeg、gif、png格式上传。';
$lang['groupbuy_message_not_start'] = '摇号活动尚未开始';
$lang['groupbuy_message_close'] = '摇号活动已经结束';
$lang['groupbuy_message_start'] = '数量有限请您尽快下单';
$lang['groupbuy_message_success'] = '摇号成功可继续购买';

/**
 * 错误提示
 **/
$lang['groupbuy_unavailable'] = '摇号功能没有开启';
$lang['no_groupbuy_template_in_progress'] = '没有正在进行中的摇号活动';
$lang['no_groupbuy_info'] = '没有摇号信息';
$lang['no_groupbuy_template_soon'] = '没有即将开始的摇号活动';
$lang['no_groupbuy_template_history'] = '没有历史摇号活动';
$lang['no_groupbuy'] = '当前没有摇号信息';
$lang['param_error'] = '参数错误';
$lang['group_name_error'] = '摇号名称不能为空';
$lang['group_goods_error'] = '请选择摇号商品';
$lang['group_help_error'] = '摇号说明不能为空';
$lang['start_time_error'] = '开始时间不能为空';
$lang['end_time_error'] = '结束时间不能为空';
$lang['groupbuy_price_error'] = '请输入正确的摇号价格';
$lang['group_pic_error'] = '摇号图片不能为空，且必须为jpg/gif/png格式';
...
$lang['groupbuy_none'] = '平台当前没有进行中的摇号活动';
$lang['group_goods_is_exist'] = '该商品已经在本期摇号活动中，请选择其它商品';
$lang['goods_info'] = '商品信息';
$lang['buyer_list'] = '购买记录';
$lang['store_info'] = '店铺信息';
$lang['groupbuy_not_state'] = '摇号活动尚未开始';
$lang['groupbuy_closed'] = '摇号活动已经结束';
$lang['goods_not_enough'] = '商品库存不足';
$lang['groupbuy_not_enough'] = '摇号余额不足';
$lang['groupbuy_sale_quantity'] = '您最多只能购买';
$lang['can_not_buy'] = '您不能购买自己发布的商品';

$lang['groupbuy_add_success'] = '摇号活动发布成功';
$lang['groupbuy_add_fail'] = '摇号活动发布失败';
$lang['groupbuy_edit_success'] = '摇号活动编辑成功';
$lang['groupbuy_edit_fail'] = '摇号活动编辑失败';
$lang['groupbuy_quota_add_success'] = '摇号活动套餐购买成功';

/**
 * 文字
 **/
$lang['groupbuy_title'] = '商品摇号';
$lang['groupbuy_soon'] = '即将开始';
$lang['groupbuy_history'] = '往期摇号';
$lang['text_year'] = '年';
$lang['text_month'] = '月';
$lang['text_day'] = '日';
$lang['text_tian'] = '天';
...
$lang['text_di'] = '第';
$lang['text_qi'] = '期';
$lang['text_groupbuy'] = '商城摇号';
$lang['text_groupbuy_list'] = '摇号列表';
$lang['text_groupbuy_detail'] = '摇号详情';
...
$lang['groupbuy_index_add_success']			= '添加摇号活动成功';
$lang['groupbuy_index_add_fail']			= '添加摇号活动失败';
$lang['groupbuy_index_not_exists']			= '未找到摇号活动';
$lang['groupbuy_index_modify_success']		= '修改摇号活动成功';
$lang['groupbuy_index_modify_fail']			= '修改摇号活动失败';
$lang['groupbuy_index_default_spec']		= '默认规格';
$lang['groupbuy_index_all_group']			= '全部摇号';
...
$lang['groupbuy_index_input_name']			= '请填写摇号名称';
$lang['groupbuy_index_desc']				= '摇号说明';
$lang['groupbuy_index_end_time']			= '结束时间';
$lang['groupbuy_index_search_first']		= '请先搜索摇号商品';
...
$lang['groupbuy_index_input_right_price']	= '请正确填写摇号价格';
$lang['groupbuy_index_max_per_user_error']  = '请正确填写每人限购数量';
$lang['groupbuy_index_input_price']			= '请填写摇号价格';
$lang['groupbuy_index_base_info']			= '摇号基本信息';
...
$lang['groupbuy_index_publish_tip']			= '如果“立即发布”，除“摇号说明”外的信息将不能再被更改';
$lang['groupbuy_index_start_time']			= '开始时间';
$lang['groupbuy_index_end_time']			= '结束时间';
$lang['groupbuy_index_goods_info']			= '摇号商品信息';
...
$lang['groupbuy_index_group_espect_num']	= '能完成摇号的期望订购人数';
$lang['groupbuy_index_group_amount']		= '成抢件数';
$lang['groupbuy_index_group_espect_amount']	= '能完成摇号的期望订购件数';
...
$lang['groupbuy_index_group_price']			= '摇号价';
$lang['groupbuy_index_search']				= '查询';
$lang['groupbuy_index_submit']				= '提交';
$lang['groupbuy_index_new_group']			= '新增摇号';
$lang['lotnumber_index_new_group']			= '新增摇号';
$lang['groupbuy_index_activity_state']		= '活动状态';
$lang['groupbuy_index_start_time']			= '起始时间';
$lang['groupbuy_index_group_num']			= '已摇号';
...
$lang['groupbuy_index_del_tip']				= '若该摇号已完成，则删除该摇号将导致未下单的用户无法下单，您确定要这么做吗';
$lang['groupbuy_index_order']				= '订单';
$lang['groupbuy_index_order_state']			= '订购情况';
$lang['groupbuy_index_finish_tip']			= '该操作将要把摇号设置为成功状态，您确定要结束预定吗';
...
$lang['groupbuy_index_group_canceled']			= '摇号商品已取消';
...
$lang['groupbuy_index_del_success']		= '删除摇号活动成功';
$lang['groupbuy_index_del_fail']		= '删除摇号活动失败';
$lang['groupbuy_index_datefail']		= '日期不能小于当日，\n默认摇号时间为7天！';
$lang['groupbuy_index_startdatefail']		= '摇号开始时间不早于当日，\n默认摇号开始时间为当日！';
