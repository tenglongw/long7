...
<![endif]-->
<script>
var COOKIE_PRE = '53C0_';var _CHARSET = 'utf-8';var SITEURL = '/shop';var RESOURCE_SITE_URL = '/data/resource';var SHOP_RESOURCE_SITE_URL = '/shop/resource';var SHOP_TEMPLATES_URL = '/shop/templates/default';</script>
<script type="text/javascript" src="/data/resource/js/jquery.js"></script>
<script type="text/javascript" src="/shop/resource/js/seller.js"></script>
...
<script type="text/javascript" src="/data/resource/js/member.js" charset="utf-8"></script>
...
$(function(){
    $('#show_shipping').on('hover',function(){
        var_send = '1970-01-01 08:00:00&nbsp;&nbsp;卖家已发货<br/>';
    	$.getJSON('index.php?act=store_deliver&op=get_express&e_code=&shipping_code=&t=PQIRT8Z',function(data){
    		if(data){
    			data = var_send+data;
