...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?act=store_lotnumber&op=lotnumber_save" method="post" enctype="multipart/form-data">
    <dl>
...
<?php } ?>
    ...
    <dl>
      <dt><i class="required">*</i>摇号商品图片<?php echo $lang['nc_colon'];?></dt>
      <dd>
    ...
    <!-- <dl>
      <dt>摇号推荐位图片<?php echo $lang['nc_colon'];?></dt>
      <dd>
    ...
    <!-- <dl>
      ...
      <dd>
        <input class="w70 text" id="upper_limit" name="upper_limit" type="text" value="1"/>
        <span></span>
...
$(document).ready(function(){
    ...
    $('[nctype="btn_upload_image"]').fileupload({
        dataType: 'json',
            url: "<?php echo urlShop('store_lotnumber', 'image_upload');?>",
            add: function(e, data) {
