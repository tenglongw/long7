...
global $config;
 $ACCESS_PWD='wangwang'; #script access password, SET IT if you want to protect script from public access
 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - always recommended to set $ACCESS_PWD to protect your db!
 $DB=array(
 'user'=>$config['db']['1']['dbuser'],#required
 'pwd'=>$config['db']['1']['dbpwd'], #required
 'db'=>$config['db']['1']['dbname'],  #default DB, optional
 'host'=>$config['db']['1']['dbhost'],#optional
 'port'=>$config['db']['1']['dbport'],#optional
