 ...
 */
       ...
       // $groupbuy_list = Model('groupbuy')->getGroupbuyListByGoodsCommonIDString(implode(',', $commonid_array));
        ...
        foreach ($goods_list as $key => $value) {
			...
			//$goods_list[$key]['appoint_satedate'] = date('Y-m-d H:i', $value['appoint_satedate']);
...
//             unset($goods_list[$key]['nc_distinct']);
    ...
    public function goods_detailOp() {
       ...
       // echo json_encode($goods_detail);exit;
        ...
        $goods_detail['store_info']['t_id'] = $store_info['member_id'];
        $goods_detail['store_info']['t_name'] = $store_info['member_name'];
