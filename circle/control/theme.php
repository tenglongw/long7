...
// 	}
	...
	public function image_uploadOp(){
		...
		if($count < 10){
			...
			//设置上传文件的格式
			$upload -> allowExts = array('jpg','png','jpeg','mp4');
	...
	public function ajax_likeyesOp(){
		...
		if(empty($like_info)){
			// 插入话题赞表
			Model()->table('circle_like')->insert(array('theme_id'=>$this->t_id, 'member_id'=>$_SESSION['member_id'], 'member_name'=>$_SESSION['member_name'], 'circle_id'=>$this->c_id));
			// 更新赞数量
